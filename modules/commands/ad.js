...
module.exports.run = async ({ api, event, args, client, Users, Threads, __GLOBAL, Currencies }) => {
  ...
  var callback = () => api.sendMessage({
    body: `梁ADMIN BOT梁
  👀 Họ và tên:Nguyễn Minh Vy
  ❎ Tuổi: 2008
  👤 Giới tính: Nữ
  🙄 Sinh ngày: 15/12/2008
  💫 Chiều cao / cân nặng: 5m
  💘 Mối quan hệ : hẹn hò
  😎 Quê quán: đồng nai
  🤔 Nơi ở: Bình Dương
  ♓ Cung: Nhân mã
  ...
  📱 Facebook: https://www.facebook.com/Phank05
...
------------
✔Donate:
💳MB: 0 có bank card đi
📲Zalo: 0349299210
----Phank----`, attachment: fs.createReadStream(__dirname + "/cache/5.jpg")
